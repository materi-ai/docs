...
description: Real-time collaborative document editing service with WebSocket support
icon: zap
source: /Users/alexarno/materi/domain/relay/README.md
sourceRepo: "https://github.com/materi-ai/materi"
lastMigrated: "2026-01-09T08:53:26.271077Z"
status: migrated
tags: 
relatedPages:
...
-   ✅ User status management (active/idle/away)
...
-   ✅ Protocol Buffer-based event contracts
...
└─────────┬───────┘    └─────────┬───────┘    └─────────┬───────┘
          ...
          └──────────────────────┼──────────────────────┘
              ...
              │                   │                   │
    ┌─────────▼──────────┐ ┌──────▼──────┐ ┌─────────▼──────────┐
    │    PostgreSQL      │ │    Redis    │ │    Main API        │
    │  (Operations &     │ │ (Presence & │ │   (Auth & Docs)    │
...
**Production Binary**: ✅ Clean build with zero warnings
...
**Built with ❤️ by the Materi Engineering Team**
